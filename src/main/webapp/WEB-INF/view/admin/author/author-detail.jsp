                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <form:form id="formCreateAuthor" modelAttribute="currentAuthor">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <form:input class="form-control" type="date" id="birthDate"
                                                                name="birthDate" path="birthDate" disabled="true" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-5">
                                                            <form:input class="form-control" type="text"
                                                                ...
                                                                name="nationality" path="nationality" disabled="true" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="biography"
                                                                id="biography" rows="5" cols="100"
                                                                disabled="true">${currentAuthor.biography}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="html5-date-input"
                                                        ...
                                                        <div class="col-md-5">
                                                            <form:input class="form-control" type="text"
                                                                id="nationality" placeholder="vnkunn123"
