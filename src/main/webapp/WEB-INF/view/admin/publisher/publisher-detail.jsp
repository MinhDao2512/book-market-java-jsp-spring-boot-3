<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="/resources/taglib.jsp" %>
        ...
        <head>
            ...
            <title>StorySwap.vn | Chi tiết nhà xuất bản</title>
                                ...
                                <form:form id="formUpdatePublisher" modelAttribute="currentPublisher">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="fw-bold py-3 mb-4">
                                            ...
                                            <span class="text-muted fw-light">Nhà Xuất Bản /</span> id =
                                            ${currentPublisher.id}
                                        </h4>
                                    </div>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                                ...
                                                                <form:input class="form-control" type="text"
                                                                    ...
                                                                    name="website" path="website" disabled="true" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <form:input class="form-control" type="text" id="address"
                                                                ...
                                                                path="address" disabled="true" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="defaultSelect" class="col-md-2 col-form-label">Ngày
                                                            Khởi Tạo:</label>
                                                        <div class="col-md-4">
                                                        ...
                                                        <label for="defaultSelect" class="col-md-2 col-form-label">Người
                                                            Khởi Tạo:</label>
                                                        <div class="col-md-4">
                                                            <form:input class="form-control" type="text" id="craetedBy"
                                                                placeholder="vnKun" name="createdBy" path="createdBy"
                                                                disabled="true" />
                                                        </div>
                                                    </div>
                                                </div>
