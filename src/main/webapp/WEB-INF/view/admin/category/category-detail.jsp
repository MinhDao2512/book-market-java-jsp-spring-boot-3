<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="/resources/taglib.jsp" %>
        ...
        <head>
            ...
            <title>StorySwap.vn | Chi tiết thể loại</title>
                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <form:form modelAttribute="currentCategory">
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <label for="html5-date-input"
                                                            class="col-md-2 col-form-label">Người Khởi Tạo:</label>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <label for="html5-date-input"
                                                            class="col-md-2 col-form-label">Người Cập Nhật:</label>
                                                        <div class="col-md-4">
                                    ...
                                    <div class="row justify-content-center mt-4">
                                        <div class="col-xl-7">
                                            <div class="d-flex justify-content-between">
                                                <a href="/admin/categories" class="btn btn-outline-secondary">Quay
                                                    lại</a>
