<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="/resources/taglib.jsp" %>
        ...
        <head>
            ...
            <title>Story Swap| Đăng ký</title>
        ...
        <body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="app-brand justify-content-center">
                                    <a href="index.html" class="app-brand-link gap-2">
                                        ...
                                        <span class="app-brand-text demo text-body fw-bolder">Story Swap</span>
                                    </a>
                                </div>
                                <!-- /Logo -->
                                ...
                                <form id="formAuthentication" class="mb-3" action="/api/register" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control validate" id="phoneNumber"
                                            name="phoneNumber" placeholder="Nhập số điện thoại của bạn" />
                                        <div class="invalid-feedback">
                                            Bạn chưa nhập địa chỉ số "Điện Thoại"
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 form-password-toggle">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="confirmPassword" class="form-control validate"
                                                ...
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="password" />
                                            <span class="input-group-text cursor-pointer" id="hide-confirmPassword"><i
                                                    class="bx bx-hide"></i></span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input validate" type="checkbox" id="confirmService"
                                                name="terms" />
                                            <label class="form-check-label" for="terms-conditions" id="checkLabel">
                                                Tôi đồng ý với
                                                <a href="javascript:void(0);">điều khoản và dịch vụ</a>
                                            </label>
                                            <div class="invalid-feedback">
                                                Bạn chưa đồng ý với "Điều khoản và Dịch vụ"
                                            </div>
                                        </div>
                                    </div>
            ...
            <script src="/admin/js/validation/auth/auth-register.js"></script>
        </body>
